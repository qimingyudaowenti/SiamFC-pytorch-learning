...
from data_prepare.utils.process_image import get_crops, Rectangle, convert_bbox_format
from data_prepare.utils.misc_funcs import mkdir_p
...
def process_split(root_dir, save_dir, split, subdir='', ):
    ...
    for idx, video in enumerate(video_names):
        print('{split}-{subdir} ({idx}/{total}): Processing {video}...'.format(split=split, subdir=subdir, idx=idx, total=len(video_names), video=video))
